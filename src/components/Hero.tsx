      ...
      <div className="container-custom relative z-10">
        <div className="flex flex-col lg:flex-row items-center gap-12">
          ...
          <div className="lg:w-1/2 relative">
            ...
            {/* Floating card 1 */}
            {/* <div className={cn(
              "absolute top-10 -left-10 glass-card p-4 shadow-lg animate-float",
              ...
              <div className="flex items-center">
                ...
                <div>
                  <p className="text-sm font-medium text-blue-900">Investment Growth</p>
                  <p className="text-xs text-finance-slate">+27% this year</p>
                </div>
              </div>
            </div> */}
